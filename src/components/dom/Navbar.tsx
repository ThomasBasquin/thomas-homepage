...
const LINKS: { id: SectionId; num: string; label: string }[] = [
  { id: "about", num: "01", label: "À propos" },
  { id: "experience", num: "02", label: "Parcours" },
  { id: "projects", num: "03", label: "Projets" },
      ...
      >
        ...
        >
          <span className="font-display text-2xl font-bold leading-none text-star">
            tb<span className="text-cyan">.</span>
          </span>
        </button>
        ...
        {/* Contact direct — pas encore de CV public */}
        <a
