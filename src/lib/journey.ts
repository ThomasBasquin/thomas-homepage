...
export const SECTIONS = [
  { id: "hero", label: "Accueil", range: [0.0, 0.1] },
  { id: "launch", label: "Décollage", range: [0.1, 0.19] },
  { id: "about", label: "À propos", range: [0.19, 0.34] },
  { id: "experience", label: "Parcours", range: [0.34, 0.5] },
  { id: "skills", label: "Compétences", range: [0.5, 0.62] },
  { id: "projects", label: "Projets", range: [0.62, 0.8] },
